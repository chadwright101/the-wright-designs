        ...
        <div className="grid grid-cols-[78px_1fr] items-center">
          ...
          {!showEmail ? (
            <p
              ...
              className="text-[1.3rem] tablet:hover:underline underline-offset-8 decoration-[1.5px] py-3 px-2 -my-3 -mx-2 hover:cursor-pointer tablet:p-0 tablet:m-0 italic text-linkBlue"
            >
              Show email
            </p>
          ) : (
