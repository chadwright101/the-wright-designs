...
const HeroComponent = () => {
  return (
    <main className="pt-10 px-5 -mx-5 tablet:px-10 tablet:-mx-10 bg-[url('/assets/images/hero-background.webp')] bg-cover bg-center">
      <div className="flex flex-col bg-gradient-to-b from-beige/90 from-30% via-45% via-beige/75 to-60% to-beige/95 pt-10 -mt-10 px-5 -mx-5 tablet:px-10 tablet:-mx-10 gap-10 desktopSmall:grid grid-cols-2 desktopSmall:bg-gradient-to-r desktopSmall:from-40% desktopSmall:from-beige/90 desktopSmall:via-60% desktopSmall:via-beige/40 desktopSmall:to-90% desktopSmall:to-beige/75 desktopSmall:py-10">
        <div className="desktopSmall:w-[476px] desktopSmall:grid gap-5">
          <h1 className="text-[24px] tracking-[0.48px] leading-[120%] font-extralight uppercase grid gap-y-1.5 pb-3 border-b-4 border-pink desktopSmall:grid-cols-[1fr_37px] desktopSmall:text-[21.75px] desktopSmall:gap-x-5 desktopSmall:font-normal desktopSmall:max-h-[231.52px]">
          ...
          <h2 className="hidden text-[20px] tracking-[0.6px] font-extralight">
          ...
          <div className="hidden gap-5 desktopSmall:grid">
            <h2 className="text-[20px] tracking-[0.6px] font-extralight">
